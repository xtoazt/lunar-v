  ...
  var e = {
      ...
      2712: function (e, t, r) {
        ...
        class g {
          ...
          Proxy(e, t) {
            ...
            if (!o) return;
            let a = Reflect.get(o, n);
            (this.natives.store[e] = a), this.RawProxy(o, n, t);
          }
          RawProxy(e, t, r) {
          ...
          Trap(e, t) {
            ...
            if (!o) return;
            let a = (0, c.nativeGetOwnPropertyDescriptor)(o, n);
            return (this.descriptors.store[e] = a), this.RawTrap(o, n, t);
          }
          RawTrap(e, t, r) {
            if (!e || !t || !Reflect.has(e, t)) return;
          ...
          e.Trap('Node.prototype.baseURI', {
            ...
            e.Proxy('Element.prototype.setAttribute', {
              apply(t) {
                ...
                o &&
                  ...
                  t.fn.call(t.this, `scramjet-attr-${t.args[0]}`, n));
              },
            }),
            ...
            e.Proxy('Element.prototype.setAttributeNS', {
              apply(t) {
                ...
                a &&
                  ((t.args[2] = a.fn(o, e.meta, e.cookieStore)),
                  e.natives.call(
      ...
      4306: function (e, t, r) {
        ...
        !(function (e, t) {
          ...
          P(o, t),
            ...
            _(new WebAssembly.Instance(e, o), e, r);
        })({
	...
	`
      ...
      7481: function (e, t, r) {
        ...
        function a(e, t) {
          ...
          t.Worker &&
            ...
            (r = e.natives.construct('Worker', o.vc.files.sync));
      ...
      6321: function (e, t, r) {
        ...
        function s(e, t) {
          Object.defineProperty(t, n.h3.config.globals.pushsourcemapfn, {
            value: (e, t) => {
              ...
              for (let e = 0; e < i; e++) {
                ...
                if (((l += 1), 0 == e)) {
                  ...
                  l += 4;
                  let r = n.getUint32(l, !0);
                  l += 4;
                  let o = n.getUint32(l, !0);
                  (l += 4), s.push({ type: e, offset: t, start: r, size: o });
                } else if (1 == e) {
                  let t = n.getUint32(l, !0);
                  l += 4;
                  let o = n.getUint32(l, !0);
                  l += 4;
                  let i = n.getUint32(l, !0);
                  l += 4;
                  let c = a.decode(r.subarray(o, i));
                  s.push({ type: e, offset: t, start: o, end: i, str: c });
                }
              }
              o[t] = s;
            },
          ...
          e.Proxy('Function.prototype.toString', {
            apply(e) {
              ...
              parseInt(t.substring(a + r.length, s));
              let i = t.indexOf('*/', a),
                l = t.substring(s + 1, i);
              t = t.replace(/\/\*scramtag.*?\*\//g, '');
              let c = o[l];
              for (; 0 < c.length; );
              return (n += t.slice(0)), e.return(n);
            },
          });
        }
      },
        ...
        function o(e, t) {
          e.Proxy('Worker', {
            construct({ args: t, call: r }) {
              (t[0] = (0, n.dm)(t[0], e.meta) + '?dest=worker'),
